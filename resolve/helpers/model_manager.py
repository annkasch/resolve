...
from resolve.network_architectures import Autoencoder, IsolationForestWrapper, VariationalAutoencoder, NeuralDensityRatioEstimator, SupervisedContrastive, InfoNCE, FTTransformer, XGBoostWrapper, LightGBMWrapper
...
class ModelsManager():
    def __init__(self, config, **kwargs):
        ...
        self._factories = {
            ...
            "LGBMResidualFT": lambda cfg: LGBMResidualFT(d_theta=cfg["d_theta"], d_phi=cfg["d_phi"], d_y=cfg["d_y"], tree_config=cfg["tree_config"], d_model=cfg.get("representation_size", 64), depth=cfg.get("depth", 1), n_heads=cfg.get("n_heads", 4), threshold=cfg.get("threshold", [0.1, 0.9]), use_tokenizer=cfg.get("use_tokenizer", False), use_cls_token=cfg.get("use_cls_token", True)),
        }
